...
VERSION = "v5_rf_3"
TRAIN_PATH = "old/train_outlier_fixed_ffill.csv"
SUB_PATH = "sample_submission.csv"
OUT_PATH = "submission_v5_rf_3.csv"
METRICS_PATH = "metrics_v5_rf_3.json"
PROFILE = {"fill": "ffill", "outlier": True}
...
def candidate_models():
    models = [
        ModelWrapper("rf", RandomForestRegressor(n_estimators=500, max_depth=18, min_samples_leaf=2, max_features="sqrt", bootstrap=True, n_jobs=-1, random_state=SEED)),
        ModelWrapper("extra_trees", ExtraTreesRegressor(n_estimators=500, max_depth=22, min_samples_leaf=2, max_features="sqrt", n_jobs=-1, random_state=SEED)),
        ModelWrapper("lgb_tweedie", lgb.LGBMRegressor(objective="tweedie", tweedie_variance_power=1.2, n_estimators=1200, learning_rate=0.03, num_leaves=255, min_child_samples=60, subsample=0.85, colsample_bytree=0.85, reg_alpha=0.03, reg_lambda=0.8, random_state=SEED, n_jobs=-1, verbosity=-1)),
        ModelWrapper("lgb_poisson", lgb.LGBMRegressor(objective="poisson", n_estimators=1200, learning_rate=0.03, num_leaves=255, min_child_samples=60, subsample=0.85, colsample_bytree=0.85, reg_alpha=0.03, reg_lambda=0.8, random_state=SEED + 1, n_jobs=-1, verbosity=-1)),
        ModelWrapper("lgb_log1p", lgb.LGBMRegressor(objective="regression", n_estimators=1200, learning_rate=0.03, num_leaves=255, min_child_samples=60, subsample=0.85, colsample_bytree=0.85, reg_alpha=0.03, reg_lambda=0.8, random_state=SEED + 2, n_jobs=-1, verbosity=-1), log_target=True),
        ModelWrapper("lgb_rf", lgb.LGBMRegressor(boosting_type="rf", objective="regression", n_estimators=800, learning_rate=0.05, num_leaves=255, min_child_samples=40, bagging_fraction=0.75, bagging_freq=1, feature_fraction=0.75, random_state=SEED + 3, n_jobs=-1, verbosity=-1)),
    ]
    if USE_XGB:
